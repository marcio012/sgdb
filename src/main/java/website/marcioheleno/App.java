...
import website.marcioheleno.service.*;
import website.marcioheleno.utils.GlobalVariables;
...
public class App {
    ...
    public static void main(String[] args) {
        ...
        log.info("Path do arquivo " + inputPath());
    ...
    private static ArrayList<BlocoContainer> processarArquivos(File[] arquivos) {
        ...
        for (File file: arquivos) {
            ...
            {
                System.out.println("\n=============================================================================\n");
                System.out.println(" **Iniciando** Criando Tabela *" + file.getName() + "*");
                ...
                System.out.println(" **Finalizado** Fim da Criação da Tabela *" + file.getName() + "*");
    ...
    private static ArrayList<RowId> sortearRowId(ArrayList<BlocoContainer> containers) {
        System.out.println("\n=====================================================================================\n");
        System.out.println(" **Iniciando** a Seleção dos RowIds");
        ...
        System.out.println(" **Finalizado** Fim da Seleção dos RowIds");
        System.out.println("Tempo de execução: " + (System.currentTimeMillis() - tempoInicio) + "\n");

        System.out.println("\n=====================================================================================\n");
        System.out.println(" **Inicializando** o Gravando RowIds Sorteados");
        ...
        System.out.println(" **Finalizado** o Fim da Gravanção do RowIds Sorteados");
        System.out.println("Tempo de execução: " + (System.currentTimeMillis() - tempoInicio) + "\n");
